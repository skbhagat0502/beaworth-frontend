    ...
    <Fragment>
      {loading ? (
        ...
        <div className="w-full aspect-video relative">
          <div className="w-full h-full m-auto group max-[420px]:w-full mb-2">
            <div
              style={{
                backgroundImage: `url(${
                  baners?.length
              ...
              className="aspect-video w-full bg-center bg-cover duration-500 relative"
            >
            ...
            {isAuthenticated && user?.role === "admin" && (
              <div className="flex gap-4 justify-center items-center mt-[-2rem]">
                <div
